...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/saiq_bots')
            ],
            [
                InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url=f"https://t.me/saiq_bots"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ ꜱᴀɪQ ᴍᴏᴠɪᴇꜱ ⚡', url='https://t.me/saiqMmovies'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇꜱ 🤖', url='https://t.me/saiq_bots')
            ],[
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ ꜱᴀɪQ ᴍᴏᴠɪᴇꜱ ⚡', url='https://t.me/saiqmovies'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇꜱ🤖', url='https://t.me/saiq_bots')
            ],[
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/saiq_bots') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
